        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          <Field>
            ...
            <select
              ...
              required
              className="w-full h-10 rounded-md border border-input bg-background px-3 text-xs font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
          ...
          {selectedProduct?.variants && selectedProduct.variants.length > 0 && (
            <Field>
              ...
              <select
                ...
                required
                className="w-full h-9 rounded-md border border-input bg-background px-3 text-xs font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
          ...
          <DialogFooter className="pt-3 border-t flex-row justify-between items-center gap-2">
            <Button
              type="button"
              variant="outline"
